...
@Component({
  selector: 'app-tour',
  standalone: true,
  imports: [CurrencyPipe, CommonModule, RouterLink, RouterOutlet],
...
export class TourComponent {
  ...
  // loadTours(): void {
  //   this.tourService.sortTours(this.status,this.location,this.minPrice,this.maxPrice,this.direction,this.sortBy,this.page,this.size).subscribe({
  //     next: (tours) => {
  //       this.tours = tours;
  //       this.paginatedTours = this.tours.slice(0, 6);
  //     },
  //     error: (err) => {
  //       console.log(err);
  //     }
